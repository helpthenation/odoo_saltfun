odoo.define('chain_environment_checkup', function (require) {
    "use strict";
    ...
    var SystrayIcon =  Widget.extend({
      ...
      load: function(dashboards){
        ...
        Users.call('has_group', ['base.group_erp_manager']).then(function(is_admin) {
          if (is_admin) {
            session.rpc('/chain_environment_checkup/data', {})
              .then(function (data) {
                ...
                self.replaceElement(QWeb.render('ChainEnvironmentCheckupIcon', {
                  'result': result,
...
// v.10  var Dashboard = Widget.extend({
        ...
        load: function (dashboards) {
            ...
            session.rpc('/chain_environment_checkup/data', {})
                .then(function (data) {
                    self._replaceElement(QWeb.render('ChainEnvironmentCheckupDashboard', {'data': data})); //  v.10: self.replaceElement
                    loading_done.resolve();
                });
            return loading_done;
        },
...
//!JW - nowa propozycja: core.action_registry.add('chain_environment_checkup.environment_checkup', Dashboard);
    core.action_registry.add('chain_environment_checkup.dashboard', Dashboard);
////////////////////
    /* v.10
    var FormWidget = form_common.AbstractField.extend({
        ...
        render_value: function() {
          ...
          this.replaceElement(QWeb.render('ChainEnvironmentCheckupFormWidget', {'data': data}));
        },
      });
    ...
    */
    ...
    var FormWidget = FormView.extend({
        ...
        render_value: function () {
            ...
            this._replaceElement(QWeb.render('ChainEnvironmentCheckupFormWidget', {'data': data}));
        }
    });
    core.form_widget_registry.add('chain_environment_checkup', FormWidget);
// registry.add("chain_environment_checkup", FormWidget);
////////////////////
    return {
