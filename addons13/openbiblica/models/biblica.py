...
class Biblicas(models.Model):
    ...
    team_ids = fields.Many2many('res.users', relation='biblica_team_1_rel', string='colaborators')
    approver_ids = fields.Many2many('res.users', relation='biblica_approver_1_rel', string='approvers')   # todo TypeError: Many2many fields open.biblica.approver_ids and open.biblica.team_ids use the same table and columns
