...
class Lines(models.Model):
    ...
    team_ids = fields.Many2many('res.users', relation='line_team_1_rel', string='colaborators')
    approver_ids = fields.Many2many('res.users', relation='line_approver_1_rel', string='approvers')
