...
class Covers(models.Model):
    ...
    team_ids = fields.Many2many('res.users', relation='cover_team_1_rel', string='colaborators')
    approver_ids = fields.Many2many('res.users', relation='cover_approver_1_rel', string='approvers')
