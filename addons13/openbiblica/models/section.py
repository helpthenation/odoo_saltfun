...
class Sections(models.Model):
    ...
    team_ids = fields.Many2many('res.users', relation='section_team_rel', string='colaborators')
    approver_ids = fields.Many2many('res.users', relation='section_approve_rel', string='approvers')
    ...
    favourite_ids = fields.Many2many('res.users', relation='section_favour_rel', string='Favourite')
