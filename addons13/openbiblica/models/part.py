...
class Parts(models.Model):
    ...
    team_ids = fields.Many2many('res.users', relation='part_team_1_rel', string='colaborators')
    approver_ids = fields.Many2many('res.users', relation='part_approver_1_rel', string='approvers')
