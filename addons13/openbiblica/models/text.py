...
class Texts(models.Model):
    ...
    team_ids = fields.Many2many('res.users', relation='text_team_rel', string='colaborators')
    approver_ids = fields.Many2many('res.users', relation='text_approve_rel', string='approvers')
