...
class HelpdeskTeam(models.Model):
    ...
    def create(self, values):
        ...
        res.message_subscribe(partner_ids=res.member_ids.user_id.partner_id.ids)  # todo error
        return res

    def write(self, vals):
        if vals.get('member_ids', False):
            self.message_subscribe(partner_ids=self.member_ids.user_id.partner_id.ids)
            # https://github.com/odoo/odoo/commit/b6d2351df45bdd049e42e828743b5dd2f1941649
    ...
    def get_bar_graph_datas(self):
        data = []
        today = datetime.strptime(fields.Date.to_string(datetime.today()), DF)
        # Ref : https: // odoo - new - api - guide - line.readthedocs.io / en / latest / fields.html
